...
collaborative_story = """You would never guess what can happen when you jump into a seemingly shallow puddle at night time!
...
for char in collaborative_story:
    if char.isalpha():  # build the word if it's a letter
        word += char
    else:
        if word:
            ...
            pig_latin += pig_word
            word = ""
        pig_latin += char  # preserve punctuation and spacing
